...
import gestao.config.audit.AuditEventConverter;
import gestao.domain.PersistentAuditEvent;
...
import static gestao.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
